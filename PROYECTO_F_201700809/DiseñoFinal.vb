...
Public Class DiseñoFinal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROYECTO_F_201700809.DiseñoFinal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDiseñoFinal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DiseñoFinal = New DiseñoFinal()
        rpt.Site = Me.Site
        Return rpt
    End Function
